...
public class HelloServletIntegrationTest {
    ...
    public void test01() throws Exception {
        //given
        String uri = uri("/Book");
        List<NameValuePair> postParameters = Arrays.
                asList(
                        new BasicNameValuePair("title", "Thinking in Java"),
                        new BasicNameValuePair("isbn", "12345678")
                );
        ...
        String htmlResponse = EntityUtils
                .toString(getResponse.getEntity());
        assertThat(htmlResponse).contains("Thinking in Java", "12345678");
    }
